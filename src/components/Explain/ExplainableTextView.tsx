    ...
    <>
      ...
      {!isPanelOpen && history.length > 0 && (
        <button
          ...
          className="fixed right-0 top-1/2 z-[60] -translate-y-1/2 rounded-l-lg border border-slate-700/90 bg-slate-900/95 px-2 py-2 text-[11px] font-medium text-slate-200 shadow-lg transition-colors hover:bg-slate-800"
        >
          Explain Panel
        </button>
      )}
